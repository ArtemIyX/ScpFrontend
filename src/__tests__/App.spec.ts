...
describe('App', () => {
  it('renders the routed game ui view', async () => {
    ...
    expect(wrapper.text()).toContain('GToolbar')
    expect(wrapper.text()).toContain('GStat')
    ...
    expect(wrapper.text()).toContain('No squad members')
    expect(wrapper.text()).toContain('Squad channel unstable')
    expect(wrapper.text()).toContain('Containment protocol updated')
    expect(wrapper.text()).toContain('Search logs')
    ...
    expect(wrapper.text()).toContain('Compact runtime readouts')
    ...
    expect(wrapper.find('.gemptystate').exists()).toBe(true)
    expect(wrapper.find('.galert').exists()).toBe(true)
    expect(wrapper.find('.gbanner').exists()).toBe(true)
    ...
    expect(wrapper.find('.gaccordion').exists()).toBe(true)
    ...
    expect(wrapper.find('.gtoolbar').exists()).toBe(true)
    expect(wrapper.find('.gstat').exists()).toBe(true)
